...
def main():
    ''' creates a new frontier with initial state and goal state 
        and adds a new limit, where is the depth of the search tree''' 

    l = 1
    initial = 'California'
    _goal = 'Washington'
    frontier = Stack(initial,_goal,l)
...
class Stack():
    ...
    def __init__(self, state,stateGoal,l):
